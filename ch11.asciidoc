...
. This draft opinion deals with the ethical issues involving accepting cryptocurrency for advance payment of legal services.  Which of these issues also apply when accepting payments for legal services that have already been performed.  

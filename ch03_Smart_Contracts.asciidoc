...
Smart contracts enable programmatic payments over a blockchain as described in chapter 2.  Chapter 3 asks the question of When can a smart contract itself be the target of legal action.  
...
The discussion of Tornado Cash is then continued in the court decision in Van Loon vs. Department of Treasury.

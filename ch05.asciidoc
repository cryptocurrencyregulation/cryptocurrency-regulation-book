...
[quote, U.S. Department of the Treasury, U.S. Treasury Issues First-Ever Sanctions on a Virtual Currency Mixer&comma; Targets DPRK Cyber Threats]
____
...
. How can a balance between no sensorship (a feature claimed by cryptocurrencies) and security be achieved? 
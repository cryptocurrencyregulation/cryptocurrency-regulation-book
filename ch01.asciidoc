...
On October 31, 2008, a paper titled "https://bitcoin.org/bitcoin.pdf[Bitcoin: A Peer-to-Peer Electronic Cash System]" was published on the internet under the alias of Satoshi Nakamoto. In this Chapter, we will revisit and discuss different sections of this paper.
